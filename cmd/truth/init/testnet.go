...
import (
	...
	srvconfig "github.com/ipxchain/ipxchain/server/config"
	sdk "github.com/ipxchain/ipxchain/types"
	"github.com/ipxchain/ipxchain/scp/auth"
	authtx "github.com/ipxchain/ipxchain/scp/auth/client/txbuilder"
	...
	"github.com/ipxchain/ipxchain/server"
)
...
func TestnetFilesCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Truth testnet",
...
Example:
	truth testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "truth",
		"Home directory of the node's daemon configuration",
	)
	cmd.Flags().String(flagNodeCliHome, "truthcli",
...
func initTestnet(config *tmconfig.Config, cdc *codec.Codec) error {
	...
	for i := 0; i < numValidators; i++ {
		...
		gaiaConfigFilePath := filepath.Join(nodeDir, "config/truth.toml")
