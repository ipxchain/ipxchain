...
import (
	...
	gaiabank "github.com/ipxchain/ipxchain/cmd/truth/app/x/bank"

	bam "github.com/ipxchain/ipxchain/baseapp"
	...
	distr "github.com/ipxchain/ipxchain/scp/distribution"
	"github.com/ipxchain/ipxchain/scp/gov"
	"github.com/ipxchain/ipxchain/scp/mint"
	"github.com/ipxchain/ipxchain/scp/params"
...
var (
	DefaultCLIHome  = os.ExpandEnv("$HOME/.truthcli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.truth")
)
...
// custom logic for truth initialization
func (app *GaiaApp) initChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
	...
	if err != nil {
		panic(err) // TODO https://github.com/ipxchain/ipxchain/issues/468
