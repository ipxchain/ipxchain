...
import (
	...
	store "github.com/ipxchain/ipxchain/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "ipxchain/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "ipxchain/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "ipxchain/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "ipxchain/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "ipxchain/baseapp/msgNoDecode", nil)
