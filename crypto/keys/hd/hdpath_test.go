...
func ExampleSomeBIP32TestVecs() {
	...
	fmt.Println("keys from fundraiser test-vector (ipxchain, bitcoin, ether)")
	fmt.Println()
	// ipxchain
	...
	// Output: keys from fundraiser test-vector (ipxchain, bitcoin, ether)
	//
