...
import (
	...
	"github.com/ipxchain/ipxchain/scp/gov"
	gcutils "github.com/ipxchain/ipxchain/scp/gov/client/utils"
)
...
Query details for a proposal. You can find the proposal-id by running truthcli query gov proposals:

$ truthcli query gov proposal 1
`),
...
$ truthcli query gov proposals --depositor cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ truthcli query gov proposals --voter cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ truthcli query gov proposals --status (DepositPeriod|VotingPeriod|Passed|Rejected)
`),
		RunE: func(cmd *cobra.Command, args []string) error {
...
Example:
$ truthcli query gov vote 1 cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
Example:
$ truthcli query gov deposit 1 cosmos1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
func GetCmdQueryDeposits(queryRoute string, cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		Long: strings.TrimSpace(`
Query details for all deposits on a proposal. You can find the proposal-id by running truthcli query gov proposals:

$ truthcli query gov deposits 1
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
func GetCmdQueryTally(queryRoute string, cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		Long: strings.TrimSpace(`
Query tally of votes on a proposal. You can find the proposal-id by running truthcli query gov proposals:

$ truthcli query gov tally 1
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ truthcli query gov param voting
$ truthcli query gov param tallying
$ truthcli query gov param deposit
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
