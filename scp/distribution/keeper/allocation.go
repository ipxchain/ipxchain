...
func (k Keeper) AllocateTokens(ctx sdk.Context, sumPrecommitPower, totalPower int64, proposer sdk.ConsAddress, votes []abci.VoteInfo) {
	...
	// general discussions here: https://github.com/ipxchain/ipxchain/issues/2906#issuecomment-441867634
	if totalPower == 0 {
	...
	// TODO consider parallelizing later, ref https://github.com/ipxchain/ipxchain/pull/3099#discussion_r246276376
	for _, vote := range votes {
		validator := k.stakingKeeper.ValidatorByConsAddr(ctx, vote.Validator.Address)

		// TODO consider microslashing for missing votes.
		// ref https://github.com/ipxchain/ipxchain/issues/2525#issuecomment-430838701
